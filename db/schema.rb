...
ActiveRecord::Schema[7.2].define(version: 2026_01_31_095053) do
  ...
  create_table "offline_bookings", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "offline_schedule_id"
    t.string "status", default: "confirmed"
    t.datetime "booked_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["offline_schedule_id"], name: "index_offline_bookings_on_offline_schedule_id"
    t.index ["user_id"], name: "index_offline_bookings_on_user_id"
  end

  create_table "offline_schedules", force: :cascade do |t|
    t.bigint "course_id"
